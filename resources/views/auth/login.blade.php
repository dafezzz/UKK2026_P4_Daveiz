            ...
            <div class="card login-card border-0">
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h2 class="brand-title text-dark">Welcome Back</h2>
                        <p class="text-muted small">Login ke sistem perpustakaan</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('password.request') }}" class="small text-link">
                                Lupa password?
                            </a>
                        </div>
                    ...
                    <div class="text-center">
                        <a class="small text-link" href="{{ route('register') }}">
